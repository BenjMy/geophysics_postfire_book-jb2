...
creating hydrophobic layers, disrupting pore structure, and redistributing moisture
{cite}`alcaniz_effects_2018`. These changes produce measurable **contrasts** that
geophysics can track non-invasively across space and time {cite}`mary2020coupled`.
