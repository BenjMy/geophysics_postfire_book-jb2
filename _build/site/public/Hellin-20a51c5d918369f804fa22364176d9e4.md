...
```{raw} html
<div id="map-hellin" style="height:350px; width:100%; border-radius:8px; margin: 1em 0;"></div>
<script>
(function() {
  function initMap() {
    var el = document.getElementById('map-hellin');
    ...
    function buildMap() {
      var map = L.map('map-hellin').setView([38.52, -1.7], 12);
      L.tileLayer('https://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png', {
        attribution: '© <a href="https://www.openstreetmap.org/copyright">OpenStreetMap</a> contributors'
      }).addTo(map);
      L.marker([38.52, -1.7]).addTo(map)
        .bindPopup('<b>Hellín</b><br>Soil moisture catchment study')
        .openPopup();
    }
