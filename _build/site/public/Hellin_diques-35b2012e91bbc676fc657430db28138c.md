...
(function() {
  function initMap() {
    var el = document.getElementById('map-diques');
    ...
    function buildMap() {
      var map = L.map('map-diques').setView([38.5, -1.68], 13);
      L.tileLayer('https://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png', {
        attribution: '© <a href="https://www.openstreetmap.org/copyright">OpenStreetMap</a> contributors'
      }).addTo(map);
      L.marker([38.5, -1.68]).addTo(map)
        .bindPopup('<b>Dique 1</b><br>Check dam — sediment monitoring')
        .openPopup();
    L.marker([38.498, -1.676]).addTo(map)
      .bindPopup('<b>Dique 2</b><br>Check dam — sediment monitoring');
    L.marker([38.495, -1.671]).addTo(map)
      .bindPopup('<b>Dique 3</b><br>Check dam — sediment monitoring');
    }
