...
```{raw} html
<div id="map-agramon" style="height:350px; width:100%; border-radius:8px; margin: 1em 0;"></div>
<script>
(function() {
  function initMap() {
    var el = document.getElementById('map-agramon');
    ...
    function buildMap() {
      var map = L.map('map-agramon').setView([38.43, -1.55], 12);
      L.tileLayer('https://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png', {
        attribution: '© <a href="https://www.openstreetmap.org/copyright">OpenStreetMap</a> contributors'
      }).addTo(map);
      L.marker([38.43, -1.55]).addTo(map)
        .bindPopup('<b>Agramón</b><br>Soil moisture catchment study')
        .openPopup();
    }
